...
$(document).ready(function () {
    ...
    if (ID != "") {
        ...
        $("#demo").pagination({
            dataSource: function (done) {
                ...
                $.ajax({
                    type: "get",
                    url: `${APIURL}/api/BaiVietApi/HienThiDanhSachBaiViet?chuyenmuc=${ID}`,
                    dataType: "json",
                    success: function (data) {
                        console.log(data);
                        if (data.length > 0) {
    ...
    $(document).on("click", ".titleDanhMuc", function (e) {
        console.log(123)
        $.ajax({
            type: "get",
            ...
            success: function (data) {
                ...
                <li >
                    ...
                    <img src=${APIURL}/${item.anhDaiDien != null ? item.anhDaiDien : `/upload/bg-cay-alt.png`} alt="Cây cấm trồng"/>
                   <span>${item.tenLoaiCay}</span>
                    </div>
            ...
            success: function (data) {
                ...
                <li >
                    <div class='detail-cayxanh' data-value=${item.id}>
                        <img src=${APIURL}/${item.anhDaiDien != null ? item.avatar : `/upload/bg-cay-alt.png`} alt="Cây cấm trồng"/>
