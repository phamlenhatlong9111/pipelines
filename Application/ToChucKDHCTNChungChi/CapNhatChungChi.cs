...
{
    public class CapNhatChungChi
    {
        public class Command : IRequest<Result<PTD_ToChucKDHCTNChungChi>>
        {
            public PTD_ToChucKDHCTNChungChi Entity { get; set; }
        }
            ...
            public async Task<Result<PTD_ToChucKDHCTNChungChi>> Handle(Command request, CancellationToken cancellationToken)
            {
                using (var connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    try
                    {
                        ...
                        parameters.Add("@PMaChungChi", request.Entity.MaChungChi);
                        ...
                        var result = await connection.QueryFirstOrDefaultAsync<PTD_ToChucKDHCTNChungChi>("TDC_Update_ToChucKDHCTN_ChungChi", parameters, commandType: System.Data.CommandType.StoredProcedure);
