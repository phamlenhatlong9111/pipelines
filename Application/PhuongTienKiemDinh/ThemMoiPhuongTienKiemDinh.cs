...
{
    public class ThemMoiPhuongTienKiemDinh
    {
        public class Command : IRequest<Result<PTD_PhuongTienKiemDinh>>
        {
            public PTD_PhuongTienKiemDinhAddModel Entity { get; set; }
        }
            ...
            public async Task<Result<PTD_PhuongTienKiemDinh>> Handle(Command request, CancellationToken cancellationToken)
            {
                using (var connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    try
                    {
                        ...
                        var result = await connection.QueryFirstOrDefaultAsync<PTD_PhuongTienKiemDinh>("TDC_Add_PhuongTienKiemDinh", parameters, commandType: System.Data.CommandType.StoredProcedure);
