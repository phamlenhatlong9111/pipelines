            ...
            public async Task<Result<PTD_LinhVuc>> Handle(Command request, CancellationToken cancellationToken)
            {
                using (var connettion = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    try
                    {
                        ...
                        parameters.Add("@PMALINHVUC", request.Entity.MaLinhVuc);
                        ...
                        var result = await connettion.QueryFirstOrDefaultAsync<PTD_LinhVuc>("TDC_Update_LinhVuc", parameters, commandType: System.Data.CommandType.StoredProcedure);
