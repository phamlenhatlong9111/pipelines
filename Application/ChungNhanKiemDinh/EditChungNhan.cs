            ...
            public async Task<Result<PTD_ChungNhanKiemDinh>> Handle(Command request, CancellationToken cancellationToken)
            {
                using (var connettion = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    try
                    {
                        ...
                        parameters.Add("@PMaGiayChungNhan", request.Entity.MaGiayChungNhan);
                        ...
                        var result = await connettion.QueryFirstOrDefaultAsync<PTD_ChungNhanKiemDinh>("TDC_Update_ChungNhanKiemDinh", parameters, commandType: System.Data.CommandType.StoredProcedure);
